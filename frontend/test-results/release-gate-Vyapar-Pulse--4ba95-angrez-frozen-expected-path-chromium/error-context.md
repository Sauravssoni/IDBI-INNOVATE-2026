...
- Name: release-gate.spec.ts >> Vyapar Pulse Release Gate >> Rangrez frozen expected path
- Location: e2e/release-gate.spec.ts:109:7
...
Locator: locator('text=DECLINED').or(locator('text=Declined')).or(locator('text=FROZEN'))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=DECLINED').or(locator('text=Declined')).or(locator('text=FROZEN'))
...
- main:
  - link "BACK TO CASE INVENTORY":
    - /url: /cases
  - text: Hackathon prototype—not an official IDBI Bank production system
  - heading "Rangrez Textiles" [level=1]
  - text: Decision Pending
  - paragraph: "ID: ecb0249a... •"
  - button "Overview"
  - button "Evidence Data"
  - button "Reconciliation"
  - button "Assessment History"
  - text: "Requested Amount ₹45.00 lakh Supportable Amount ₹55.62 lakh DSCR 7.26x Recommendation Ready For Review Evidence Confidence 80.0% MSME Credit Twin Source Coverage 80% Evidence Confidence 80.0% Reconciliation Quality 98.64153729990939293264874660% Model: DSCR_SANDBOX_V1 Evaluated: 7/9/2026, 11:41:41 AM Evidence Reconciliation Revenue Matching 101.4% Match GST Turnover: ₹4.17 Cr Bank Credits: ₹4.23 Cr Reconciliation Engine Deterministic Reconciliation"
  - heading "Governance & Access Controls" [level=2]
  - paragraph:
    - text: Logged in as
    - strong: Credit Analyst
    - text: (Credit Analyst) • Scoped Access
  - heading "Credit Analyst Workflows" [level=3]
  - paragraph: Submit formal recommendation to the Sanctioning Authority based on the assessment.
  - button "Re-run Assessment"
  - 'button "Submit: Recommend As Requested (₹55.62 lakh)"'
