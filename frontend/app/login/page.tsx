...
import {
  ShieldCheck, Lock, Mail, ArrowRight, UserCheck, Briefcase, TrendingUp, AlertCircle, RefreshCw, Search, PlayCircle
} from "lucide-react";
    ...
    <div className="min-h-screen bg-brand-nav text-light-text flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white w-full max-w-lg p-8 rounded-lg shadow-2xl border border-light-border z-10">
        ...
        {serviceStatus === "unavailable" && (
          <div className="mb-6 p-4 bg-brand-softRed border border-brand-red rounded-lg text-brand-red text-sm font-medium flex flex-col gap-2 text-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <button
                  ...
                  disabled={isSubmitting || serviceStatus === "unavailable"}
                  className="p-3 bg-light-bg border border-light-border hover:border-brand-amber hover:bg-brand-softAmber text-left rounded-lg transition-all flex items-center gap-3 disabled:opacity-50 disabled:hover:bg-light-bg disabled:hover:border-light-border"
                >
                ...
                <button
                  ...
                  disabled={isSubmitting || serviceStatus === "unavailable"}
                  className="p-3 bg-light-bg border border-light-border hover:border-light-secondary hover:bg-light-elevated text-left rounded-lg transition-all flex items-center gap-3 disabled:opacity-50 disabled:hover:bg-light-bg disabled:hover:border-light-border"
                >
