...
- Name: release-gate.spec.ts >> Vyapar Pulse Release Gate >> NavPrerna evidence-request/defer path
- Location: e2e/release-gate.spec.ts:81:7
...
Locator: locator('text=DEFER').or(locator('text=Defer'))
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('text=DEFER').or(locator('text=Defer'))
...
- main:
  ...
  - heading "Navprerna Tech Solutions" [level=1]
  - text: Assessment Completed
  - paragraph: "ID: 5b2a2dde... •"
  - button "Overview"
  - button "Evidence Data"
  - button "Reconciliation"
  - button "Assessment History"
  - text: "Requested Amount ₹30.00 lakh Supportable Amount ₹0 DSCR 2.41x Recommendation Additional Evidence Required Evidence Confidence 0.0% MSME Credit Twin Source Coverage 60% Evidence Confidence 0.0% Reconciliation Quality 98.16850789589981723173816392% Model: DSCR_SANDBOX_V1 Evaluated: 7/9/2026, 11:41:41 AM Evidence Reconciliation Revenue Matching 357.5% Match GST Turnover: ₹45.03 lakh Bank Credits: ₹1.61 Cr Reconciliation Engine Deterministic Reconciliation"
  ...
  - 'button "Submit: Request Additional Evidence"'
