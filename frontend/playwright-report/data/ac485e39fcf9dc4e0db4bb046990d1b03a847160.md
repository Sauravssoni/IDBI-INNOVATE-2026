...
- Name: release-gate.spec.ts >> Vyapar Pulse Release Gate >> Shakti guided flow reaches all stages and captures screenshots
- Location: e2e/release-gate.spec.ts:35:7
...
Locator: locator('text=MSME Credit Twin')
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('text=MSME Credit Twin')
...
- alert
- banner:
  - link "Vyapar Pulse IDBI INNOVATE 2026":
    - /url: /
  - 'textbox "Search business ID, legal name, GSTIN or case #..."'
  - text: ⌘K Assessment Service Credit Analyst (Credit Analyst)
  - button "Sign out of Vyapar Pulse"
- complementary:
  - text: Navigation & Workflows
  - link "Dashboard":
    - /url: /
  - link "Case Inventory":
    - /url: /cases
  - link "Policy & Risk Engine AI":
    - /url: /policy
  - text: Governance & Access
  - paragraph: Role-Scoped Access enforced. Tamper-evident prototype audit chain.
- main:
  - link "Leave Sandbox":
    - /url: /login
  - button "Restart Sandbox"
  - text: DSCR_SANDBOX_V1 Credit Analyst
  - heading "Live Case Evaluation" [level=1]
  - paragraph: Guided walkthrough of deterministic credit scoring and multi-actor governance
  - text: Business & request Evidence coverage Reconciliation 4 Credit Twin 5 Analyst recommendation 6 Human sanction & audit
  - heading "Computed Credit Twin" [level=2]
  - paragraph: Review the resulting reconciliation metrics and deterministic scores.
  - heading "Deterministic Reconciliation Checks" [level=3]
  - text: "GST vs Bank Credits Aligned GST periods with BUYER_RECEIPT bank credits. Observed: ₹2.61 Cr | Reference: ₹2.68 Cr | Variance: ₹6.67 L (2.4933645415044596%) Refs: 36 evidence items MATCHED v1.1 Invoices vs Payments Compared expected settled invoices to total linked payments. Observed: ₹2.32 Cr | Reference: ₹2.32 Cr | Variance: ₹0 (0%) Refs: 102 evidence items MATCHED v1.1 Payroll vs Employment Checked PF remittance vs 12% of salary payments (sandbox rule). Observed: ₹4.82 L | Reference: ₹4.82 L | Variance: ₹0.007 (0.000001494331697270086%) Refs: 36 evidence items MATCHED v1.1 Obligations vs Debt Service Compared 18 months of debt service debits to bureau EMIs. Observed: ₹41.08 L | Reference: ₹41.08 L | Variance: ₹0 (0%) Refs: 19 evidence items MATCHED v1.1 Circular Flow Analysis Awaiting adequate counterparty/reference data. MISSING EVIDENCE v1.1 System Recommendation CONDITIONAL OFFER Binding Support Limit ₹35.69 lakh"
  - button "Back"
  - button "Prepare Recommendation"
  - text: Built for IDBI Innovate 2026 • Hackathon prototype—not an official IDBI Bank production system Illustrative prototype policy thresholds • Tamper-evident prototype audit chain
```
