...
- **Demonstrability**: The master script orchestrates linting, testing, end-to-end proofs, and database teardowns with exactly four predictable personas (Shakti, Navprerna, Rangrez, Aarohan).
