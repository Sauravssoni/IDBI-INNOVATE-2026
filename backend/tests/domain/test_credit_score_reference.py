...
def test_fhi_and_credit_score_perfect_verified_case():
    features = {
        ...
        "gst_metrics": {"months_filed": 12, "avg_monthly_revenue": "1000000", "revenue_cv": "0.05", "trend": "GROWING"},
    ...
    assert fhi_data["score_range"] == {"lower": 885, "upper": 900, "basis": "evidence-conditioned assessment range; not a statistical confidence interval"}
...
def test_fhi_and_credit_score_intermediate_values():
    features = {
        ...
        "gst_metrics": {"months_filed": 12, "avg_monthly_revenue": "1000000", "revenue_cv": "0.18", "trend": "STABLE"},
