...
def get_case_bankability_path(
    ...
    return compute_bankability_path(
        features,
        scores,
        requested_amount,
        requested_product,
...
def post_case_bankability_path(
    ...
    return compute_bankability_path(
        features, scores, requested_amount, requested_product, target_amount=tgt
    )
...
def post_case_bankability_simulate(
    ...
    return simulate_bankability_variable(
        features, scores, requested_amount, requested_product, overrides
    )
