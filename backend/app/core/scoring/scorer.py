    ...
    def compute_all_scores(self) -> Dict[str, Any]:
        ...
        if inflows > 0 and cash_flow_status == "SUFFICIENT_CASH_FLOW_DATA":
            ...
            ledger.append({
                ...
                "evidence_ids": inflow_evd + outflow_evd, "running_score": float(base + earned + deductions)
            })
        ...
        if obligation_state in ASSESSABLE_OBLIGATION_STATES and cash_flow_status == "SUFFICIENT_CASH_FLOW_DATA" and operating_cash > 0:
            ...
            ledger.append({
                ...
                "evidence_ids": inflow_evd + outflow_evd + obligation_evd, "running_score": float(base + earned + deductions)
            })
        ...
        if months >= 6 and cv_val != "UNKNOWN":
            ...
            ledger.append({
                ...
                "evidence_ids": gst_evd, "running_score": float(base + earned + deductions)
            })
        ...
        if obligation_state in ASSESSABLE_OBLIGATION_STATES and cash_flow_status == "SUFFICIENT_CASH_FLOW_DATA" and operating_cash > 0:
            ...
            ledger.append({
                ...
                "evidence_ids": obligation_evd + inflow_evd, "running_score": float(base + earned + deductions)
            })
        ...
        if ratio_val != "UNKNOWN":
            ...
            ledger.append({
                ...
                "evidence_ids": gst_evd + inflow_evd, "running_score": float(base + earned + deductions)
            })
