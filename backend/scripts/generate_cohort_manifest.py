...
def generate_manifest():
    ...
    def make_case(
        cid, name, req_amt, req_prod, rev, in_flow, out_flow, emi, rate=0.135, tenure=36
    ):
        return {
            "case_id": cid,
            "business_name": name,
    ...
    cases.append(
        make_case(
            "CASE_007", "Startup Nil", 1000000, "WORKING_CAPITAL_LINE", 0, 0, 0, 0
        )
    )
    ...
    print(
        "Generated 10 deterministic cases in artifacts/validation/cohort_manifest.json"
    )
